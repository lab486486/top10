...
강아지·고양이 사료를 **예산(kg당 가격대)**과 **공개 스코어**로 비교하는 TOP5 파인더입니다.

- 히어로: kg당 가격대 듀얼 슬라이더 → 스코어 순 TOP5
- 펫푸드 스코어: 고기·단백·가성비·알러지·알크기 (가중치 공개)
- 브랜드 표기 등급(참고)과 펫푸드 스코어 밴드 분리
...
5. 도메인 연결: Pages 프로젝트 → **Custom domains**에서 연결
